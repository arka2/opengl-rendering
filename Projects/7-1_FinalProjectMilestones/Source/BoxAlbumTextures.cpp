///////////////////////////////////////////////////////////////////////////////
// BoxAlbumTextures.cpp
// ========
// create box mesh that uses texture atlas for photo album
//
...
BoxAlbumTextures::BoxAlbumTextures()
{
...
///////////////////////////////////////////////////
void BoxAlbumTextures::LoadBoxMesh()
{
...
// 
///////////////////////////////////////////////////
void BoxAlbumTextures::DrawBoxMesh()
{
	glBindVertexArray(m_BoxMesh.vao);
...
glm::vec3 BoxAlbumTextures::CalculateTriangleNormal(glm::vec3 p0, glm::vec3 p1, glm::vec3 p2)
{
...
void BoxAlbumTextures::SetShaderMemoryLayout()
{
